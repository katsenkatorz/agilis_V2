...
class Agilis_Model_Page {
	...
	private function pageCadres(){
		$requete = "SELECT * FROM zz5_pagesCadres WHERE SUBSTRING_INDEX(zz_pc_code,'_',3) = '".$this->page['code']."' ORDER BY zz_pc_top,zz_pc_left";
	...
	private function pageControleur(){
		$pageControleur = null;
//		$this->page['variables']['var_page_monocadre'] = 0;
		//Si page mono-cadre
		if(! empty($this->page['cadres']) && $this->page['cadres'][0]['zz_pc_code'] == $this->page['code'].'_cadre'){
			...
			$this->page['variables']['var_cadre_code'] = $this->page['code']."_cadre";
//			$this->page['variables']['var_page_monocadre'] = 1;
		}//end if
